...
export class MWpBAq1688877877754 implements MigrationInterface {
    name = 'MWpBAq1688877877754'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`rbac_permission\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL COMMENT '权限名', \`label\` varchar(255) NULL COMMENT '权限别名', \`description\` text NULL COMMENT '权限描述', \`rule\` text NOT NULL COMMENT '具体的权限规则', \`customOrder\` int NOT NULL COMMENT '权限排列字段' DEFAULT '0', \`parentName\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
