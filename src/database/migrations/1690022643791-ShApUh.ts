...
export class ShApUh1690022643791 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`content_posts\` ADD CONSTRAINT \`FK_f8fdfad5ebf43387e5bdbd57b1f\` FOREIGN KEY (\`coverImgId\`) REFERENCES \`medias\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`content_posts\` DROP FOREIGN KEY \`FK_f8fdfad5ebf43387e5bdbd57b1f\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_f8fdfad5ebf43387e5bdbd57b1\` ON \`content_posts\``);
